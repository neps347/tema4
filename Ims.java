...
public class Ims {
	...
	//Calculo IMC en base a datos obtenidos CON POW error 30¿?//
	double imc = (double)peso /  ((Math.pow(altura, altura)));
	//IMS = peso / altura2
	...
	//System.out.println (Math.pow(altura, altura));
			System.out.println("Tu imc deberia de estar entre 18 y 25: i " + (18>25));
