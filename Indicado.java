...
public class Indicado {
	...
	public static void main(String[] args) {
		...
		//System.out.print("la tirada mas alta ha sido" + sumatirada1 + sumatirada2);
		
		
		
        System.out.println("La tirada de Pedro a sido mayor o igual que: " + (sumatirada1>=sumatirada2));
        
        //Intente resolverlo hasta que recorde que comentaste de añadir el if y else. lo dejo como paso de comprobacion
        System.out.print("El ganador es:");
        if(sumatirada1>=sumatirada2)
            System.out.print("Ha ganado pedro");
        	//valor = sumatirada1;
        else
           System.out.print("ha ganado Manuel");
